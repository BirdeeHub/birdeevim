...
The automatically generated init.vim calls:
```
lua require('myLuaConfig')
```
This is generated in [NeovimBuilder](./nix/NeovimBuilder.nix) 

So if you want to change the name of that folder, also change it there in the 4 places it shows up.
...
-- [NeovimBuilder](./nix/NeovimBuilder.nix)
    ...
    in the 4 places this file mentions it
